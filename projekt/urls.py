...
from .views.facilitator.scenario import ScenarioView, CreateScenarioView, ScenarioDetailView, ScenarioSubmitView, ScenarioEndView, ShowResultView,generate_json
...
new_urls = [
    ...
    path('scenarios/view/<pk>/result', ShowResultView.as_view(), name='show-result'),
